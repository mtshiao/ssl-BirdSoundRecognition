...
This repository provides the code and resources for our bird sound classifier, which leverages self-supervised learning to analyze vast amounts of unlabeled soundscape recordings collected from subtropical montane forests. 

## **Key Features**
1. **Focused on dawn chorus bird song recognition**: The model is designed to classify bird songs during the dawn chorus. We trained the model using recordings from this specific period and validated its effectiveness through practical inference tests.  
