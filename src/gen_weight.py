...
if __name__ == '__main__':
    ...
    json_file=Path.cwd().parents[3].joinpath('Audio_data', 'finetune_train.json')
    label_file=Path.cwd().parents[3].joinpath('Audio_data', 'finetune_labels_indices.csv')
    output_file=Path.cwd().parents[3].joinpath('Audio_data', 'weigh_all.csv')
