...
class MaskedAutoencoderViT(nn.Module):
    ...
    """
    def __init__(self, img_size=128, patch_size=16, stride=10, in_chans=3,
        ...
        if self.use_custom_patch: # overlapped patches as in AST. Similar performance yet compute heavy
            ...
            window_size= (4,4)
            # feat_size = (64,8) # as set
            # feat_size = (32,8) # esc50
            feat_size = (8,8) # spc
    ...
    def random_masking_2d(self, x, mask_t_prob, mask_f_prob):
        ...
        N, L, D = x.shape  # batch, length, dim
        if self.use_custom_patch: # overlapped patch 
            T=12           # for MAE 224 * 224 
            F=12

        else:            
            ## for SPC # for audio-MAE ，128 * 128，(128/16) * (128/16) =  8 * 8  patches
            T=8
            F=8
